...
public class CarCameraController : MonoBehaviour, IDependency<RaceStateTracker>
{
    ...
    [SerializeField] private CameraShakerAndWind shaker;
    [SerializeField] private CameraFovCorrectors fovCorrectors;
    [SerializeField] private CarPathFollower pathFollower;
    ...
    private void Awake()
    {
        ...
        fovCorrectors.SetProperties(car, camera);
    }
